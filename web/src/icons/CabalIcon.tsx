...
export const CabalIcon = memo(function CabalIcon({
  size = 16,
  className = "",
  color = "var(--color-primary)",
  withGlow = true,
}: IconProps) {
  const svgStyle: CSSProperties = withGlow
    ? { filter: "drop-shadow(0 0 3px currentColor)", color }
    : { color };
